...
namespace Xms.Infrastructure
{
    public class Guard
    {
        ...
        [DebuggerStepThrough]
        public static void NotEmpty(Func<string> arg)
        {
            if (arg().IsEmpty())
            {
        ...
        [DebuggerStepThrough]
        public static void NotEmpty(Func<Guid> arg)
        {
            if (arg() == Guid.Empty)
            {
                string argName = GetParamName(arg);
        ...
        [DebuggerStepThrough]
        public static void IsEnum(Type arg, string argName)
        {
            NotNull(arg, argName);
            if (!arg.IsEnum)
            {
        ...
        [DebuggerStepThrough]
        public static void IsEnum(Type enumType, object arg, string argName)
        {
            NotNull(arg, argName);
