        ...
        var i = {
            ...
            bindToast: function () {
                ...
                this._toastEl.on("afterShown", function () {
                 ...
                 this._toastEl.on("click", function (o) {
                    o.preventDefault(), "fade" === t.options.showHideTransition ? (t._toastEl.trigger("beforeHide"), t._toastEl.fadeOut(function () {
                        t._toastEl.trigger("afterHidden")
                    })) : "slide" === t.options.showHideTransition ? (t._toastEl.trigger("beforeHide"), t._toastEl.slideUp(function () {
                        t._toastEl.trigger("afterHidden")
                    ...
                    t._toastEl.trigger("clickHandler")
                ...
                }), "function" == typeof this.options.clickHandler && this._toastEl.on("clickHandler", function () {
                    t.options.clickHandler()
                })
            },
            addToDom: function () {
