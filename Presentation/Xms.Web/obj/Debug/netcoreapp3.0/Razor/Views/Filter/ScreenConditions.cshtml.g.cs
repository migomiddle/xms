#pragma checksum "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\ScreenConditions.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6954a4bb4e80cd6d14b36df1164d3ce3cadc4f63"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Filter_ScreenConditions), @"mvc.1.0.view", @"/Views/Filter/ScreenConditions.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6954a4bb4e80cd6d14b36df1164d3ce3cadc4f63", @"/Views/Filter/ScreenConditions.cshtml")]
    ...
    public class Views_Filter_ScreenConditions : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\ScreenConditions.cshtml"
...
<div class=""modal-body"" id=""pliot-page1"" data-page=""1"">
    ...
    <div class=""form-group"" data-type=""Main"">
        <div id=""row_1"" class=""pilot-row row"" data-isshow=""show"" style=""margin-bottom:5px;"">
            <div class=""col-sm-1"" style=""position:relative;height:30px;"">
                <em class=""pilot-choose"" onclick=""downSelect(this,'row')"" style=""display: none; background: url(/content/images/selectListR.png) center no-repeat; position: absolute; height: 15px; width: 15px; top: 30%; left: 50%; curso");
            WriteLiteral("r: pointer;\"></em>\r\n            </div>\r\n            <div class=\"col-sm-11\">\r\n                <select class=\"form-control pilot-fieldM pilot-null input-sm\">\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6954a4bb4e80cd6d14b36df1164d3ce3cadc4f636254", async() => {
                WriteLiteral("--请选择--");
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6954a4bb4e80cd6d14b36df1164d3ce3cadc4f637606", async() => {
                WriteLiteral("--请选择--");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
    ...
    <div class=""form-group"" data-type=""Relevant"">
        <div id=""row_2"" class="" pilot-row row"" data-isshow=""show"" style=""margin-bottom:5px;"">
            <div class=""col-sm-1"" style=""position:relative;height:30px;"">
                <em class=""pilot-choose"" onclick=""downSelect(this,'row')"" style=""display: none; background: url(/content/images/selectListR.png) center no-repeat; position: absolu");
            WriteLiteral("te; height: 15px; width: 15px; top: 30%; left: 50%; cursor: pointer;\"></em>\r\n            </div>\r\n            <div class=\"col-sm-11\">\r\n                <select class=\"form-control pilot-fieldR pilot-null input-sm\">\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6954a4bb4e80cd6d14b36df1164d3ce3cadc4f6310238", async() => {
                WriteLiteral("--请选择--");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                </select>\r\n            </div>\r\n            <div class=\"col-sm-3 hide\">\r\n                <select class=\"form-control pilot-condition input-sm\">\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6954a4bb4e80cd6d14b36df1164d3ce3cadc4f6311591", async() => {
                WriteLiteral("--请选择--");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
...
<script>
 ...
 ");
        ...
        $('body').on('change', '.pilot-fieldM,.pilot-fieldR', function () {
            ...
            var relevantEntityId = $(this).find('opti");
            WriteLiteral(@"on:selected').attr('data-referencedentityid');
                ...
                checkList.each(function (i, n) {
                    ...
                    if (selRela.toLowerCase() == sibEntityid.toLowerCase()) {
                        if (thatSel.find('option[value=""""]').length > 0) {
                            ...
                            var thatEntityid = thatSel.parent().parent().attr('data-rent");
            WriteLiteral(@"ityid');
                            thatSel.find('option[data-entityid=""' + thatEntityid + '""]').prop('selected', true);
                        }
                        isIn = true;
                        Xms.Web.Alert(false, '查询已存在所要添加的条件');
                        return false;
                    }
                });
                if (isIn == true) {
            ...
            if ($(this).find('option:selected').val() == '') {
                ...
                $(this).paren");
            WriteLiteral(@"ts('.pilot-row:eq(0)').find('.pilot-choose').show();
            }
            if (isrelevant == 'false') {
                    ...
                    if (datatype == ""lookup"" || datatype == ""owner"" || datatype == ""customer"") {
                       ...
                       // console.log('ConditionOperator', Xms.Fetch.ConditionOperator)
                        if (referencedentityname.toLowerCase() == ""systemuser"") {
                            ...
                            operators = Xms.Fetch.ConditionOperator.OrganizationOperators;
                        }
                    }
                }
            ...
            WriteLiteral(@"    //操作符
                ...
                if ($(this).hasClass('pilot-fieldM')) {
                    if (datatype == ""lookup"" || datatype == ""owner"" || datatype == ""customer"") {
                        ...
                        FilterDialog.bindInput($(this).parents('.pilot-row:eq(0)').find('.pilot-condition'), $(this).parents('.pilot-row:eq(0)').find('input'), datatype, attributeid, EntityId, d");
            WriteLiteral(@"dlitems, optionsetid);
                    }
                }
                ...
                if ($(this).parent().hasClass('relevant-item')) {
                    Xms.Web.Confirm(false, '所有字段及该实体的相关实体将会清除，是否继续？', function () {
    ...
    ");
        ...
        $('body').on('change', '.pilot-condition', function () {
            ...
            //}
            console.log('form-group:data-type', $(this).pare");
            WriteLiteral(@"nts('.form-group').attr('data-type'));
            if ($(this).parents('.form-group').attr('data-type') == 'Main') {
                ...
                if (datatype == ""lookup"" || datatype == ""owner"" || datatype == ""customer"") {
                    ...
                    FilterDialog.bindInput($(this), $(this).parents('.pilot-row:eq(0)').find('input'), datatype, $(this).parents('.pilot-row:eq(0)').attr('data-attributeid'), EntityId");
            WriteLiteral(@", ddlitems, $(this).parents('.pilot-row:eq(0)').attr('data-optionsetid'));
                }
    ...
    ");
            WriteLiteral(@"            ScrloadFilterAttributes(EntityId, 'pilot-fieldM', null, null);
            }
    ...
    function ScrloadFilterAttributes(entityid, classname, that, onsuccess) {
        ...
        Xms.Schema.GetAttributesByEntityId(entityid, function (data) {
            ...
            Xms.Schema.GetEntityRelations(entityid, null,  function (");
            WriteLiteral(@"data) {
                if (!data ) {
                    return;
                }
  ...
  ");
    ...
    function initFilter(fetchconfig, target) {
        ...
        var conditionHtml = EditRowHtml(condi");
            WriteLiteral(@"tion, type, ""false"", entityid, EntityName);
        ...
        ScrloadFilterAttributes(entityid, attrSel, null, function () {
            ...
            target.find('.relevant-box').each(function (i, n) {
                ...
                ");
            WriteLiteral(@"var relEntityid = $(n).attr('data-rentityid');
           ...
           ");
            WriteLiteral(@"         ajaxThat.children('.relevant-child').children('.pilot-row[data-entity=""true""]').each(function (ii, nn) {
            ...
            if (typeof isEditReport != 'undefined' && isEditReport == true) {
                ...
                if (target.attr('data-type') == 'Relevant') {
                    if (typeof RelevantEntityId != 'undefined' && RelevantEntityId != '') {
    ");
            WriteLiteral(@"                    ScrloadFilterAttributes(RelevantEntityId, 'pilot-fieldR', null, null);
                    }
                }
            }
        });
    ...
    function EditRowSet(n, attrSel,isRelevant) {
        if ($(n).attr('data-relevant') == 'false' || isRelevant) {
            ...
            if (datatype == ""lookup"" || d");
            WriteLiteral(@"atatype == ""owner"" || datatype == ""customer"") {
                Xms.Web.GetJson('/api/data/Retrieve/ReferencedRecord/' + valid + '/' + attrVal, null, function (response) {
    ...
    function EditFilterHtml(filters, type, entityid, entityname) {
        ...
        for (var i = 0; i < filters.length; i++) {
            ...
            i");
            WriteLiteral(@"f (chilFilter.length > 0) {
    ...
    function EditRowHtml(conditions, type, isrelevant, entityid, entityname) {
        ...
        for (var i = 0; i < conditions.length; i++) {
            ...
            Xms.Web.AsyncGet('/api/schema/attribute/getbyentityid/' + entityid + '/' + attrName, function (data) {
                console.log(i, entityid, attrName)
                var result = JS");
            WriteLiteral(@"ON.parse(data.Content);
                if (result != null) {
                    ...
                    _html.push('<em class=""pilot-choose"" onclick=""downSelect(this,\'row\')"" style=""position: absolute; height: 15px; width: 15px; top: 30%; ");
            WriteLiteral(@"left: 50%; cursor: pointer; background: url(/content/imgs/selectListR.png) 50% 50% no-repeat;"">');
                    _html.push('</em>');
                    _html.push('</div>');
...
");
    ...
    function EditRelevantHtml(linkEntity, type) {
        ...
        for (var i = 0; i < linkEntity.length; i++) {
            ...
            Xms.Web.AsyncGet('/api/schema/entity/getbyname/' + rentityname, function (data) {
         ...
         ");
            WriteLiteral(@"               _html.push('<select class=""form-control pilot-fieldM input-sm"">');
                    }
                    _html.push('</select>');
   ...
   ");
            WriteLiteral(@"     that.parents('.pilot-row:eq(0)').attr('data-entity', 'true');
        ...
        if (th");
            WriteLiteral(@"at.parents('.pilot-row:eq(0)').parents('.pilot-row').length > 0) {
  ...
  ");
        ...
        var grounpId = 'grou");
            WriteLiteral(@"p_' + Math.round(new Date().getTime() / 1000);
        var divHtml = [];
    ...
    function downSelect(e, type) {
        ...
        var choosegroup = '<a href=""javascript:void(0);"" onclick=""chooseRowGroup(this,\'' + rowId + '\'");
            WriteLiteral(@")"" data-event="""">选择组</a>';
 ...
 ");
            WriteLiteral(@"   function eachGroup(e, isFirst) {
        var FiltersConfig = new Xms.Fetch.FilterExpression(Xms.Fetch.LogicalOperator.And);
        console.log('filtersconfig',FiltersConfig);
        $(e).each(function (i, n) {
            if ($(n).hasClass('andorGroup')) {
                var FiltersConfigGroup = new Xms.Fetch.FilterExpression(Xms.Fetch.LogicalOperator.And);
                $(n).children().children('.pilot-row').each(function (ii, nn) {
                    if ($(nn).find('.pilot-fieldM,.pilot-fieldR').find('option:selected').val() != '') {
                        ...
                        if (datatye == ""lookup"" || datatye == ""owner"" || datatye == ""customer"" || datatye == 'primarykey') {
                            ...
                            vale = [vale];
  ");
            WriteLiteral(@"                      } else if (datatye == ""picklist"") {
                            vale = vale.split(',');
                        } else {
                            vale = [vale];
                        }
                ...
                if ($(n).attr('data-type') == 'and') {
                    FiltersConfigGroup.FilterOperator = Xms.Fetch.LogicalOperator.And;
                }
                else {
                    FiltersConfigGroup.FilterOperator = Xms.Fetch.LogicalOperator.Or;
                }
                $(n).children().children('.andorGroup').each(function (ii, nn) {
                    FiltersConfigGroup.Filters.push(e");
            WriteLiteral(@"achGroup(nn, false));
                });
                if (isFirst) {
                ...
                if ($(n).find('.pilot-fieldM,.pilot-fieldR').find('option:selected').val() != '') {
                    //FiltersConfig = new Xms.Fetch.FilterExpression();
    ...
    function eachRelevant(e, entityrelationship) {
        ...
        $(e).each(function (i, n) {
            ...
            var filterList = $(n).children().children('.relevant-child').children('.andorGroup,.pilot-row[data");
            WriteLiteral(@"-entity=""false""]');
            relevantItem.LinkCriteria = new Xms.Fetch.FilterExpression(Xms.Fetch.LogicalOperator.And);
            ...
            $(n).children('.relevant-item').children('.relevant-child').children('.relevant-box').each(function (ii, nn) {
                relevantItem.LinkEntities = eachRelevant");
            WriteLiteral("($(nn), entityrelationship, false);\r\n            });\r\n            console.log(\'relevantItem\', relevantItem)\r\n            rItem.push(relevantItem);\r\n        });\r\n        return rItem;\r\n    }\r\n</script>");
        }
