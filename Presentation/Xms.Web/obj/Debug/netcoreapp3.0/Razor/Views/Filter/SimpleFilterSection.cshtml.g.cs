#pragma checksum "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\SimpleFilterSection.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "67de320d834d70cd3365c432e13475b1b80d7220"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Filter_SimpleFilterSection), @"mvc.1.0.view", @"/Views/Filter/SimpleFilterSection.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"67de320d834d70cd3365c432e13475b1b80d7220", @"/Views/Filter/SimpleFilterSection.cshtml")]
    ...
    public class Views_Filter_SimpleFilterSection : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Xms.Web.Models.SimpleFilterModel>
    {
        ...
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_1 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("value", "attribute", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        {
#nullable restore
#line 2 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\SimpleFilterSection.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral("<div class=\"container-fluid filterSection\" style=\"max-height:400px; overflow-y:auto; width:100%;\">\r\n    <input type=\"hidden\" class=\"filtersectionData\"");
    ...
    <table class=""table"">
        ...
        <tbody>
            <tr class=""condition-clone-default"" style=""display:none;"">
                ...
                <td>
                ");
            WriteLiteral(@"    <button type=""button"" class=""btn btn-xs btn-warning"" onclick=""SimpleFilter.removeCondition(this)"">
            ...
            <tr class=""condition-item"">
                ...
                <td>
                    <select class=""form-control filter-filed-type input-sm"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "67de320d834d70cd3365c432e13475b1b80d72207058", async() => {
                WriteLiteral("值");
            }
            );
            ...
            WriteLiteral("\r\n                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "67de320d834d70cd3365c432e13475b1b80d72208236", async() => {
                WriteLiteral("字段");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
...
<script>
    function digitsValue(e){
        ...
        if(!reg.test(val)||val==''){
            if($(e).next('label[name=""digitsTip""]').length<=0){
                $('<label name=""di");
            WriteLiteral(@"gitsTip"">'+LOC_VALIDATION_DIGIT+'</label>').insertAfter($(e));
            }
            check=false;
        }
        else{
    ...
    var filterDialogEntityId = '");
#nullable restore
#line 81 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\SimpleFilterSection.cshtml"
...
#nullable disable
            WriteLiteral("\';\r\n    (function($,root,un){\r\n        var entityId = \'");
#nullable restore
#line 83 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\SimpleFilterSection.cshtml"
                   Write(Model.EntityId);
...
#nullable disable
            WriteLiteral("\';\r\n        var SimpleFilter = {\r\n            filter: ");
#nullable restore
#line 85 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Filter\SimpleFilterSection.cshtml"
...
#nullable disable
        ...
        function loadFilterData(callback) {
            ScrloadFilterAttributes(entityId, 'filter-filed-name', null, function () {
              ...
              //  console.log($('.filter-filed-name'))
                $('.condition-item .filter-filed-name').each(functi");
            WriteLiteral(@"on(){
        ...
        function loadOperators(datatype,context,callback,isdefault){
            ...
            if(context && context.length>0){
              //  console.log(context.find('select.filter-filed-name ");
           ...
           // console.log(");
            ...
            $operator.on('change',function(){
                ...
                data");
            WriteLiteral(@"type = datatype == ""primarykey""?'lookup':datatype;
                if(!isdefault){
   ...
   ");
            WriteLiteral(@"             console.log(""$operator.on('change'"",_value);
               ...
               ");
            WriteLiteral(@"         _par.find('select.filter-filed-type').prop('disabled',true);
                    } else {
        ...
        function getFilterData(){
            ...
            $conditions.each(function () {
                ...
                item.Values.push($(this).");
            WriteLiteral(@"find('input[name=""value""]').val());
        ...
        function renderFilterDom() {
          ...
          ");
            WriteLiteral(@"          $.each(filterArr, function (ii,nn) {
                        ...
                        if (ii == 0) {
                           ...
                           // console.log('conditionf.parents',conditionf.p");
            WriteLiteral(@"arents('.condition-item:first'))
...
");
            WriteLiteral(@"                                    setFilterDom(conditionf.find('.filter-filed-name').eq(0),conditionf);
                            ...
                            datatype = conditionf.find('.filter-filed-nam");
            WriteLiteral(@"e').find('option:selected').attr('data-type');
                            ...
                            loadOperators(datatype,conditionf,function(){
                                setTimeout(function(){
                                    ...
                                    if(compareattr && compareattr!=null){
                                        ...
                                        conditionf.find('.valueselecter').show();
                               ");
            WriteLiteral(@"         conditionf.find('input[name=""value""]').val(arrTostring(nn.values));
                                    }
                        ...
                        function setTypeInput(_conditionf){
                            ...
                            if(datatype=='datetime'){
                                ...
                                if(_value * 1 >= 14 && _value*1 < 31 && (_value * 1 != 26 && _value*1 != 27)){
                      ");
            WriteLiteral(@"              _conditionf.find('input[name=""value""]').prop('disabled',true);
                           ...
                           ");
            WriteLiteral(@"         _conditionf.find('select.filter-filed-type').prop('disabled',false);
                                    //_par.find('input[name=""value""],button').prop('disabled', false);
                                }
                            }
                        }
        ...
        function setFilterDom($obj,conditionf){
            var $this = $obj;
");
            WriteLiteral(@"            var datatype = $this.find('option:selected').attr('data-type');
         ...
         //   console.log(conditionf.find('.filter-filed-name').val(),conditionf.find('input[name=""value""]').val());
           ...
           // console.log(setFilterDom,datatype)
            if (datatype == ""lookup"" || datatype == ""owner"" || datatype == ""customer"" || datatype == ""primarykey"") {
                ...
                if(attrtype=='filed'){
                    EntityId ");
            WriteLiteral(@"= $this.find('option:selected').attr('data-referencedentityid');
                }
        ...
        function filterAttrNameChange() {
            var $this = $(this);
            var datatype = $this.find('option:selected').attr('");
        ...
        funct");
            WriteLiteral(@"ion filterTypeChange(){
        ...
        function ScrloadFilterAttributes(entityid, classname, that, onsuccess) {
            ...
            Xms.Web.PageCache('attributes', '/api/schema/attribute', params, function (data) {
                ...
                _ScrmainOptions.push('<optg");
            WriteLiteral(@"roup data-type=""filed"" label=""字段"">');
               // console.log('Attributes',data.content.items)
                ...
                var enParam = {
             ");
            WriteLiteral(@"       type: 'referencingentityid' + entityid,
        ...
        function initFilter(fetchconfig, target) {
            ...
            ScrloadFilterAttributes(entityId, attrSel, null, function () {
                target.fin");
            WriteLiteral(@"d('.pilot-row:not(.relevant-box)').each(function (i, n) {
                ...
                target.find('.relevant-box').each(function (i, n) {
                    ...
                    ScrloadFilterAttributes(relEntityid, null, null, function (dataHtml) {
                        ...
                        selHtml.find('option[dat");
            WriteLiteral(@"a-relevant=""true""]').each(function (ii, nn) {
                            var opRelation = $(nn).attr('data-name').toLowerCase();
                            $(nn).attr('data-name', opRelation);
                        });
                        ...
                        ajaxThat.children('.relevant-child').children('.pilot-row[data-entity=""true""]').each(function (ii, nn) {
                            ...
                            $(nn).children('.relevant-item').children('.' + attrSel).fin");
            WriteLiteral(@"d('option[data-name=""' + chilRelation + '""]').prop('selected', true);
                        });
                    });
                })
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<Xms.Web.Models.SimpleFilterModel> Html { get; private set; }
    }
}
