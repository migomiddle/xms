#pragma checksum "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a9e5b8a474ced45c8bca5ae0e55b595ba0eb8133"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Component_RenderChart), @"mvc.1.0.view", @"/Views/Component/RenderChart.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a9e5b8a474ced45c8bca5ae0e55b595ba0eb8133", @"/Views/Component/RenderChart.cshtml")]
    ...
    public class Views_Component_RenderChart : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<RenderChartModel>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 2 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
...
<div class=""rendercharbox"" style=""position:relative;"">
    ...
    <div id=""chart1"" class=""chartA xms-chart"" data-queryid=""");
#nullable restore
#line 11 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                                                       Write(Model.QueryId);
...
#line hidden
#nullable disable
            WriteLiteral("\" style=\"border:1px #efefef solid;min-height:300px;\"></div>\r\n    <span class=\"changeBig glyphicon glyphicon-resize-full\" style=\"position:absolute;right:9px;top:10px; z-index:10;cursor:pointer; opacity: .5;\"></span>\r\n</div>\r\n<script");
            BeginWriteAttribute("src", " src=\"", 593, "\"", 663, 2);
            WriteAttributeValue("", 599, "/content/js/echarts-all.js?v=", 599, 29, true);
#nullable restore
#line 14 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
WriteAttributeValue("", 628, app.PlatformSettings.VersionNumber, 628, 35, false);
...
#nullable restore
#line 23 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                  Write(Model.ChartId);
...
#nullable disable
            WriteLiteral("\';\r\n        var queryid = \'");
#nullable restore
#line 24 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                  Write(Model.QueryId);
...
#nullable disable
            WriteLiteral("\';\r\n        var entityname = \'");
#nullable restore
#line 25 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                     Write(Model.EntityName);
...
#nullable disable
        ...
        function getCrumbFilters(){
            ...
            WriteLiteral(@" = Xms.Fetch.LogicalOperator.And;
            filters.Conditions = [];
        ...
        fu");
            WriteLiteral(@"nction bindCrumbItem(e) {
            var $this = $(this);
       ...
       ");
            WriteLiteral(@"                 var _index = $this.parents('.componentbox').index();
        ...
        function groupsAttributes(obj) {
            ...
            var p");
            WriteLiteral(@"arams = groupsInserModal.data().params;
            var groupsCtrl = groupsInserModal.data().groupsCtrl[chardid];
            var groups = groupsInserModal.data().groups[chardid];
 ...
 ");
            WriteLiteral(@"               // $(params._dom).trigger('getInserComponent',{ chartid:chartid, queryid:queryid,  filter: filter, groups: groups });
                if(typeof renderChart=='function'){
...
");
        ...
        function showGroupsModal(filter,params,myChart,grpsc,grps){
            ...
            groupsIn");
            WriteLiteral(@"serModal.data().groups = grps;
     ...
     ");
            WriteLiteral(@"   if(typeof groupsCtrl[chardid]==='undefined'){
            groupsCtrl[chardid] = [];
        }
        ...
        var DataView = {
            ...
            dataConfig : ");
#nullable restore
#line 248 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                    Write(Html.Raw(Model.ChartEntity.DataConfig.ToLower()));
...
#nullable disable
            WriteLiteral(",\r\n            chartConfig : ");
#nullable restore
#line 249 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                     Write(Html.Raw(Model.Chart.SerializeToJson()));
...
#nullable disable
            WriteLiteral(",\r\n            dataSource : ");
#nullable restore
#line 250 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                    Write(Html.Raw(Model.DataSource.SerializeToJson()));
...
#nullable disable
            WriteLiteral(",\r\n            attributes : ");
#nullable restore
#line 251 "G:\projects\xms_v2\Presentation\Xms.Web\Views\Component\RenderChart.cshtml"
                    Write(Html.Raw(Model.Attributes.SerializeToJson()));
...
#nullable disable
            ...
            WriteLiteral(@");
                ...
                myChart.on('click',function(params){
                    ...
                    if(typeof groupsCtrl[chard");
            WriteLiteral(@"id]!=='undefined' && groupsCtrl[chardid].length>1){
           ...
           ");
            WriteLiteral(@"         var filter = new Xms.Fetch.FilterExpression();
                    ...
                    if(attributeTypeName[0].attributetypename == ""datetime"" && xAxis != '空'){
                        if(xAxis) {
                            ...
                            var endDateDay = null;
                            if(month == 2) {
                                endDateDay = isLeapYear(year) ? mon");
            WriteLiteral(@"thDay[month] + 1 : monthDay[month];
                            } else {
   ...
   ");
            WriteLiteral(@"                             condition.Operator = Xms.Fetch.ConditionOperator.Equal;
                            }else{
  ...
  ");
      ...
      ");
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<RenderChartModel> Html { get; private set; }
    }
}
