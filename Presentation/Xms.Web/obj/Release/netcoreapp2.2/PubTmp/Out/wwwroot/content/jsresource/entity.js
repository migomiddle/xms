...
function StartWorkFlow(entityid, recordid, callback) {
    ...
    Xms.Web.OpenDialog('/flow/startworkflow?entityid=' + entityid + '&recordid=' + recordid, null, null, callback);
}
...
function WorkFlowProcessDetail(entityid, recordid, callback) {
    ...
    Xms.Web.OpenDialog('/flow/WorkFlowInstanceDetail?entityid=' + entityid + '&recordid=' + recordid, null, null, callback);
}
