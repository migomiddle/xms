...
var SalesOrder = {
    ...
    , LookupAddress: function () {
        ...
        target.find('#dialog_shiptoaddressid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=customeraddress&inputid=dialog_shiptoaddressid', 'SalesOrder.LookupAddressCallback', { filter: filter });
            }
            , clear: function () {
        ...
        target.find('#dialog_billtoaddressid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=customeraddress&inputid=dialog_billtoaddressid', 'SalesOrder.LookupAddressCallback', { filter: filter });
            }
            , clear: function () {
    ...
    , GetProducts: function () {
        ...
        target.find('#dialog_opportunityid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=opportunity&inputid=dialog_opportunityid', 'SalesOrder.GetProductsCallback');
            }
            , clear: function () {
    ...
    , GetQuoteProducts: function () {
        ...
        target.find('#dialog_quoteid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=opportunity&inputid=dialog_quoteid', 'SalesOrder.GetQuoteProductsCallback');
            }
            , clear: function () {
                $('#dialog_quoteid').val('');
...
var Quote = {
    LookupAddress: function () {
        ...
        target.find('#dialog_shiptoaddressid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=customeraddress&inputid=dialog_shiptoaddressid', 'Quote.LookupAddressCallback', { filter: filter });
            }
            , clear: function () {
                $('#dialog_shiptoaddressid').val('');
                $('#dialog_shiptoaddressid_text').val('');
        ...
        target.find('#dialog_billtoaddressid_text').lookup({
            disabled: true,
            dialog: function () {
                Xms.Web.OpenDialog('/entity/RecordsDialog?singlemode=true&entityname=customeraddress&inputid=dialog_billtoaddressid', 'Quote.LookupAddressCallback', { filter: filter });
            }
            , clear: function () {
                $('#dialog_billtoaddressid').val('');
                $('#dialog_billtoaddressid_text').val('');
