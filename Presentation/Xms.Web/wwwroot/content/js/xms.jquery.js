...
; (function (root, $, un) {
    ...
    function autoSearcher(obj, opts, datas, groupdatas) {
        ...
        this.inputWrap = $('<div class="xms-mutilauto-inputwrap input-group"><div class="input-group-btn" data-action="remove"><span class="btn btn-default"><em class=" glyphicon glyphicon-remove"></em></span></div></div>')
        this.wrap.attr('data-isactive', false);
        this.search = $('<div class="xms-mutilauto-search"></div>');
        this.searchType = $('<input type="hidden" data-type="keyword" value="" />');
        ...
        this.groupSelecter = $('<select class="form-control"><option value="-1">根据分组过滤</option></select>');
        this.value = '';
        this.ul = $('<ul class="xms-mutilauto-ul"></ul>');
        this._parent = $(opts.context) || $('body');
        this.box.after(this.wrap);
