        ...
        switch (attrType) {
            ...
            case "owner":
                ...
                if (onlyLabel) {
                    ...
                    _control.push('<input type="hidden" class="dirtylisten haslookup' + required + '" name="' + _cell.Control.Name.toLowerCase() + '" id="' + _cell.Control.Name.toLowerCase() + '" data-attributeid="' + attrId + '" data-controltype="' + attrType + '" data-type="guid" value="' + value + '" data-lookup="' + _cell.Control.AttributeMetadata.ReferencedEntityId + '" data-relationshipname="' + ((_cell.Control.Parameters && _cell.Control.Parameters.RelationshipName) || '') + '" data-defaultviewid="' + ((_cell.Control.Parameters && _cell.Control.Parameters.DefaultViewId) || '') + '" data-localizedname="' + localizedname + '" />');
            ...
            case "picklist":
                if (onlyLabel) {
                    ...
                    _control.push('<input type="text" autocomplete="off" class="dirtylisten form-control extParamEnti input-sm picklist' + required + ' ' + isvalidate + '" name="' + _cell.Control.Name.toLowerCase() + '" data-displaystyle="' + _cell.Control.AttributeMetadata.DisplayStyle.toLowerCase() + '" id="' + _cell.Control.Name.toLowerCase() + '_text" data-attributeid="' + attrId + '" data-controltype="' + attrType + '" data-type="int" data-items="' + encodeURIComponent(JSON.stringify(_cell.Control.AttributeMetadata.OptionSet.Items)) + '" value="' + value + '" data-onlylabel="' + onlyLabel + '" data-localizedname="' + localizedname + '"' + readonly + extParamStr + ' />');
